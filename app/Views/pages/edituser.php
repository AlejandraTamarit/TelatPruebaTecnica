        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                <div class="card-header text-center">
                    <h4 class="my-0 fw-normal">Editar Usuario</h4>
                </div>
                <div class="card-body">
                    <form  action="<?= base_url('/save_edit') ?>" method="post" class="row g-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="codigo_postal" id="codigo_postal" value="<?= $usuario['codigo_postal'] ?>">
                        ...
                        <div class="col-md-6 mb-3 ">
                            ...
                            <select class="form-select form-control form-control-md " name="list_colonias" id="list_colonias" >
                                <option value="<?= $usuario['colonia'] ?>" selected><?= $usuario['colonia'] ?></option> 
                            </select>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="dele_muni" class="form-label">Delegación/Municipio</label>
                            <input type="text" class="form-control" name="dele_muni" id="dele_muni" value="<?= $usuario['dele_muni'] ?>">
                        </div>
                        <div class="col-6 mb-3">
                            <label for="estado" class="form-label">Estado</label>
                            <input type="text" class="form-control" name="estado" id="estado" value="<?= $usuario['estado'] ?>">
                        </div>
                        <div class="col-12 text-right mb-3">
                            <input class="w-20 btn btn-lg btn-outline-success" type="submit" value="Guardar Cambios">
                        </div>
                    </form>
                </div>
            </div>
