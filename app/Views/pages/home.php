        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a class="w-100 btn btn-lg btn-outline-primary" type="submit" href="<?= base_url('/add') ?>">Agregar Usuarios</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a class="w-100 btn btn-lg btn-primary" type="submit" href="<?= base_url('/view') ?>">Ver Reportes</a>
                </div>
            </div>
        </div>
    </div>
